...
/* harmony import */ var _common_guard_workflow_plan_validation_guard__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../common/guard/workflow-plan-validation.guard */ "W7TW");
/* harmony import */ var _components_workflow_data_workflow_data_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/workflow-data/workflow-data.component */ "i8eL");
/* harmony import */ var _components_workflow_home_workflow_home_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/workflow-home/workflow-home.component */ "Qx4n");
...
const routes = [
    {
        ...
        children: [
            ...
            },
            {
                path: "dashboard",
                pathMatch: "full",
                component: _components_workflow_home_workflow_home_component__WEBPACK_IMPORTED_MODULE_3__["WorkflowHomeComponent"]
            },
            {
                canActivate: [_common_guard_workflow_plan_validation_guard__WEBPACK_IMPORTED_MODULE_1__["WorkflowPlanValidationGuard"]],
                path: "create",
                pathMatch: "full",
                component: _components_workflow_data_workflow_data_component__WEBPACK_IMPORTED_MODULE_2__["WorkflowDataComponent"]
            },
            {
                path: "edit/:id",
                pathMatch: "full",
...
WorkflowRoutingModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵdefineNgModule"]({ type: WorkflowRoutingModule });
WorkflowRoutingModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵdefineInjector"]({ imports: [[_angular_router__WEBPACK_IMPORTED_MODULE_0__["RouterModule"].forChild(routes)], _angular_router__WEBPACK_IMPORTED_MODULE_0__["RouterModule"]] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵsetNgModuleScope"](WorkflowRoutingModule, { imports: [_angular_router__WEBPACK_IMPORTED_MODULE_0__["RouterModule"]], exports: [_angular_router__WEBPACK_IMPORTED_MODULE_0__["RouterModule"]] }); })();
...
/***/ "W7TW":
/*!****************************************************************!*\
  !*** ./src/app/common/guard/workflow-plan-validation.guard.ts ***!
  \****************************************************************/
/*! exports provided: WorkflowPlanValidationGuard */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "WorkflowPlanValidationGuard", function() { return WorkflowPlanValidationGuard; });
...
class WorkflowPlanValidationGuard {
            ...
            if (subscription != null) {
                if (subscription.state == _enums_subcription_state_enum__WEBPACK_IMPORTED_MODULE_2__["SubcriptionState"].PENDING) {
                    ...
                    if (subscription.track != null && subscription.plan != null) {
                        if (((_c = subscription.track) === null || _c === void 0 ? void 0 : _c.workflow) < ((_d = subscription.plan) === null || _d === void 0 ? void 0 : _d.workflow) || ((_e = subscription.plan) === null || _e === void 0 ? void 0 : _e.workflow) == -1) {
                            return success(true);
                        }
                        else {
                            this.toaster.error("Your subcription " + ((_f = subscription.plan) === null || _f === void 0 ? void 0 : _f.name) + " only allows creation of " + subscription.plan.workflow + " workflow.");
                        }
                    }
                    else {
...
WorkflowPlanValidationGuard.ɵfac = function WorkflowPlanValidationGuard_Factory(t) { return new (t || WorkflowPlanValidationGuard)(_angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵinject"](ngx_toastr__WEBPACK_IMPORTED_MODULE_4__["ToastrService"]), _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵinject"](_service_subcription_subscription_service__WEBPACK_IMPORTED_MODULE_5__["SubscriptionService"])); };
WorkflowPlanValidationGuard.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdefineInjectable"]({ token: WorkflowPlanValidationGuard, factory: WorkflowPlanValidationGuard.ɵfac, providedIn: 'root' });
...
/* harmony import */ var _scheduler_scheduler_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../scheduler/scheduler.service */ "1uZb");
/* harmony import */ var _subcription_subscription_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../subcription/subscription.service */ "4/0Z");
...
class WorkflowService {
    constructor(userService, firestore, scheduler, subscriptionService) {
    ...
    create(workflow) {
        return new Promise((resolve, reject) => Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            this.firestore.collection("workflow").add(workflow).then((value) => {
                this.subscriptionService.track(uid, _enums_tracking_type_enum__WEBPACK_IMPORTED_MODULE_1__["TrackingType"].WORKFLOW, 1);
                if (this.workflowList.length == 0) {
                    this.loadAllWorkflow();
                }
                else {
...
WorkflowService.ɵfac = function WorkflowService_Factory(t) { return new (t || WorkflowService)(_angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵinject"](_user_user_service__WEBPACK_IMPORTED_MODULE_3__["UserService"]), _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵinject"](_angular_fire_firestore__WEBPACK_IMPORTED_MODULE_4__["AngularFirestore"]), _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵinject"](_scheduler_scheduler_service__WEBPACK_IMPORTED_MODULE_5__["SchedulerService"]), _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵinject"](_subcription_subscription_service__WEBPACK_IMPORTED_MODULE_6__["SubscriptionService"])); };
WorkflowService.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineInjectable"]({ token: WorkflowService, factory: WorkflowService.ɵfac, providedIn: 'root' });
